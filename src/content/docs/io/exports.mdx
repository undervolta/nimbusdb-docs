...
| --- | --- | --- | --- | --- | --- | --- | --- |
| **Available** | Yes | Yes | Yes | Yes | <Tooltip text="You need to activate it first">[Optional](#toml)</Tooltip> | Yes | Yes |
...
<Tabs>
    ...
    4. Find `/// @options@toml-export` line, select that line and 2 lines below, and paste the copied content.
        ```
        /// @options@toml-export
        ```
