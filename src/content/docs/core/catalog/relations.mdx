...
{/* (define_relation, define_mutual_relation, drop_relation, get_relation, RelationSelector) */}
...
<Tabs syncKey='lang'>
    ...
    ctg_items.get_relation({        // using relation selector, array of this object is also allowed
