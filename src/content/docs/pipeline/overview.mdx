...
In this section, we will explore the basics of pipelines in **NimbusDB**. We'll use this schema and the `items` model as an example to demonstrate how to create and manage pipelines to transform and process data in **NimbusDB** models.
...
<Tabs syncKey='lang'>
    ...
    // move to step 2 (.limit operation)
    items_pl.move_to(2);
