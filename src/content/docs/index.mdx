...
hero:
  ...
  image:
    file: ../../assets/houston.webp	# change later
  actions:
    - text: Get Started
...
<CardGrid>
    ...
    <Card title="Community" icon="seti:notebook">
        Got questions, feature requests, or feedback? Join the discussion on [GitHub](https://github.com/undervolta/NimbusDB/discussions) or [Discord](#).
    </Card>
</CardGrid>
