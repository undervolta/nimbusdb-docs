...
<CardGrid>
    ...
    <Card title="Community" icon="seti:notebook">
        Got questions, feature requests, or feedback? Join the discussion on [GitHub](https://github.com/undervolta/NimbusDB/discussions) or [Discord](https://discord.gg/UsqbHSN23h).
    </Card>
</CardGrid>
